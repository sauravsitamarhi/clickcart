# ClickCart - E-commerce App

**ClickCart** is a modern, responsive e-commerce web application built with **React**. It includes product listings, category and price filtering, cart functionality, and more.
